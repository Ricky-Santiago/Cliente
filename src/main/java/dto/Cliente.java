...
@NamedQueries({
    ...
    @NamedQuery(name = "Cliente.findByMombClie", query = "SELECT c FROM Cliente c WHERE c.mombClie = :mombClie"),
    ...
    @NamedQuery(name = "Cliente.validar", query = "SELECT c FROM Cliente c WHERE c.ndniClie = :ndniClie and c.passClie = :passClie"),
...
public class Cliente implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 50)
    @Column(name = "mombClie")
    private String mombClie;
    @Basic(optional = false)
    @NotNull
    ...
    public Cliente(Integer codiClie, String ndniClie, String appaClie, String apmaClie, String mombClie, Date fechNaciClie, String logiClie, String passClie) {
        this.codiClie = codiClie;
        this.ndniClie = ndniClie;
        this.appaClie = appaClie;
        this.apmaClie = apmaClie;
        this.mombClie = mombClie;
    ...
    public String getMombClie() {
        return mombClie;
    }

    public void setMombClie(String mombClie) {
        this.mombClie = mombClie;
    }
